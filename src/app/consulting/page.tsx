        ...
        <div className="max-w-[700px] mx-auto text-left">
          ...
          <section>
            ...
            <p className="mb-6 leading-relaxed">
              ...
              <a href="https://www.linkedin.com/pulse/what-your-story-matters-more-now-because-machines-cant-schrott-ffc7e/" className="text-[#0000FF] hover:underline" target="_blank" rel="noopener noreferrer">why storytelling matters more now in the age of AI</a>).
            </p>
            
            <p className="mb-6 leading-relaxed">
              Most clients start with one of two types of focused support. These are set blocks of time we can use to work through narrative challenges or positioning decisions your team is facing:
            </p>
